...
inline void kernel_mm256_4x7xk(int lda, int ldb, int ldc, int K, const double *restrict A, const double *restrict B, double *restrict C)
{
  register double4 c_ymm_00, c_ymm_01, c_ymm_02, c_ymm_03, c_ymm_04, c_ymm_05, c_ymm_06;
  ...
  {
    double4 a_ymm_0k;
    double4 b_val_k0, b_val_k1, b_val_k2, b_val_k3, b_val_k4, b_val_k5, b_val_k6;
